...
<?php 
    ...
    $caminhoimg1= "./static/".$id."/".$id."1.png";
    $caminhoimg1= "./static/".$id."/".$id."2.png";
    $caminhoimg1= "./static/".$id."/".$id."3.png";
...
?>
    ...
    <div class="container">
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner" style="height: 40em; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">
